...
public class StartApplication implements CommandLineRunner {
    ...
    void startCustomerApp() {
        ...
        jdbcTemplate.execute("CREATE TABLE customer(" +
                "id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), age NUMERIC(2), created_date timestamp)");
    ...
    void startBookApp() {
        ...
        jdbcTemplate.execute("CREATE TABLE books(" +
                "id INT AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255), price NUMERIC(15, 2))");
